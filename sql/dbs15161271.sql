...
CREATE TABLE IF NOT EXISTS `event_documentation` (
  ...
  `calculations` TEXT DEFAULT NULL COMMENT 'Calculations and notes for the event',
...
CREATE TABLE IF NOT EXISTS `rentals` (
  ...
  `status` ENUM('active', 'returned', 'defective', 'pending_confirmation', 'overdue') NOT NULL DEFAULT 'active' COMMENT 'Rental status',
  `notes` TEXT,
  `defect_notes` TEXT,
  `created_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
